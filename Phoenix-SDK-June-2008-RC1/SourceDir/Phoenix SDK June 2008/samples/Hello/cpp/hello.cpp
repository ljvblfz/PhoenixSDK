...
)
{
   ...
   try
   {
      ...
      lifetime = Phx::Lifetime::New(Phx::LifetimeKind::Module, nullptr);

      Phx::Name moduleName = Phx::Name::New(lifetime, "main.obj");

      module = Phx::ModuleUnit::New(lifetime, moduleName, nullptr,
...
Hello::BuildPhaseList()
{
   ...
   phaseList->AppendPhase(Phx::RegisterAllocator::LinearScan::RegisterAllocatorPhase::New(
         config));
   phaseList->AppendPhase(Phx::StackAllocatePhase::New(config));
   phaseList->AppendPhase(Phx::Targets::Runtimes::FrameGenerationPhase::New(
         config));
   phaseList->AppendPhase(Phx::Targets::Runtimes::SwitchLowerPhase::New(
         config));
   ...
   phaseList->AppendPhase(Hello::Encode::New(config));
   phaseList->AppendPhase(Hello::Lister::New(config));
...
)
{
   ...
   UInt32 binarySize = encode->FinalizeIR();
   ...
   Phx::Symbols::SectionSymbol ^ textSectionSymbol =
      safe_cast<Phx::Symbols::SectionSymbol ^>(module->SymbolTable->ExternIdMap->Lookup(
            (UInt32) Phx::Symbols::PredefinedCxxILId::Text));
...
Hello::BuildExternalSymbols()
{
   ...
   Phx::Types::FunctionType ^ operatorNewType = typeTable->GetFunctionType(
      ...
      ptrToUnkType, module->RegisterUIntType, nullptr, nullptr, nullptr);
...
Hello::BuildBaseClass()
{
   ...
   Phx::Types::FunctionType ^ baseCtorType = typeTable->GetFunctionType(
      ...
      ptrToUnkType, ptrToCharType, nullptr, nullptr);
   ...
   Phx::Types::FunctionType ^ getMessageType = typeTable->GetFunctionType(
      ...
      ptrToBaseType, nullptr, nullptr, nullptr);
...
Hello::BuildDerivedClass()
{
   ...
   Phx::Name derivedCtorName = Phx::Name::New(lifetime,
      "??0Derived@@QAE@PBD@Z");
   ...
   Phx::Types::FunctionType ^ derivedHelloType = typeTable->GetFunctionType(
      Phx::Types::CallingConventionKind::ThisCall, 0, typeTable->VoidType,
      ptrToDerivedType, nullptr, nullptr, nullptr);
...
Hello::BuildMain()
{
   Phx::Types::FunctionType ^ mainType = typeTable->GetFunctionType(
      ...
      typeTable->VoidType, nullptr, nullptr, nullptr);
   ...
   mainSymbol->Visibility = Phx::Symbols::Visibility::GlobalDefinition;
}
...
Hello::BuildBaseCtor()
{
   ...
   Phx::Symbols::LocalVariableSymbol ^ thisSym = Phx::Symbols::LocalVariableSymbol::New(funcSymTable,
      0, Phx::Name::New(functionLifetime, "this"), ptrToBaseType,
   ...
   Phx::Symbols::LocalVariableSymbol ^ msgSym = Phx::Symbols::LocalVariableSymbol::New(funcSymTable,
      0, Phx::Name::New(functionLifetime, "msg"), ptrToCharType,
      Phx::Symbols::StorageClass::Parameter);
   ...
   Phx::IR::MemoryOperand ^ vtableMemOpnd = Phx::IR::MemoryOperand::New(function,
      vtableFieldSym->Field, nullptr, thisOperand, 0,
   ...
   Phx::Symbols::NonLocalVariableSymbol ^ localBaseVtableSym =
      Phx::Symbols::NonLocalVariableSymbol::New(
   ...
   Phx::IR::MemoryOperand ^ messageMemOpnd = Phx::IR::MemoryOperand::New(function,
      messageFieldSym->Field, nullptr, thisOperand, 0,
...
Hello::BuildBaseHello()
{
   ...
   Phx::IR::Instruction ^ callInstruction = Phx::IR::CallInstruction::New(function,
...
Hello::BuildDerivedCtor()
{
   ...
   Phx::Symbols::LocalVariableSymbol ^ thisSym = Phx::Symbols::LocalVariableSymbol::New(funcSymTable,
      0, Phx::Name::New(functionLifetime, "this"), ptrToDerivedType,
      Phx::Symbols::StorageClass::Parameter);
   ...
   Phx::Symbols::NonLocalVariableSymbol ^ localDerivedVtableSym =
      Phx::Symbols::NonLocalVariableSymbol::New(
...
Hello::BuildMainFunc()
{
   ...
   Phx::IR::MemoryOperand ^ base1VtableMemOpnd = Phx::IR::MemoryOperand::New(function,
      vtableFieldSym->Field, nullptr, base1Opnd, 0,
      Phx::Alignment::NaturalAlignment(ptrToBaseType),
      function->AliasInfo->IndirectAliasedMemoryTag,
      function->SafetyInfo->SafeTag);
   ...
   Phx::IR::MemoryOperand ^ fnPtrMemOpnd1 = Phx::IR::MemoryOperand::New(function,
      baseHelloSym->Type, nullptr, assignInstr1->DestinationOperand->AsVariableOperand, 0,
      Phx::Alignment::NaturalAlignment(ptrToBaseType),
      function->AliasInfo->IndirectAliasedMemoryTag,
      function->SafetyInfo->SafeTag);
   ...
   Phx::IR::MemoryOperand ^ base2VtableMemOpnd = Phx::IR::MemoryOperand::New(function,
      vtableFieldSym->Field, nullptr, base2Opnd, 0,
      Phx::Alignment::NaturalAlignment(ptrToBaseType),
      function->AliasInfo->IndirectAliasedMemoryTag,
      function->SafetyInfo->SafeTag);
   ...
   Phx::IR::MemoryOperand ^ fnPtrMemOpnd2 = Phx::IR::MemoryOperand::New(function,
      derivedHelloSym->Type, nullptr, assignInstr2->DestinationOperand->AsVariableOperand, 0,
      Phx::Alignment::NaturalAlignment(ptrToBaseType),
      function->AliasInfo->IndirectAliasedMemoryTag,
      function->SafetyInfo->SafeTag);
...
Hello::BuildInitializedData()
{
   ...
   Phx::Symbols::SectionSymbol ^rdataSectionSymbol =
      safe_cast<Phx::Symbols::SectionSymbol ^>(symbolTable->ExternIdMap->Lookup(
            (UInt32) Phx::Symbols::PredefinedCxxILId::Constant));
   ...
   Phx::Types::Type ^ baseVtableType = Phx::Types::AggregateType::New(typeTable,
      typeTable->NativePointerBitSize, nullptr);
   ...
   baseVtableSym->Alignment = Phx::Alignment(Phx::Alignment::Kind::AlignTo4Bytes);
   ...
   Phx::IR::DataInstruction ^ baseVtableInstr =
      Phx::IR::DataInstruction::New(rdataSection->DataUnit,
   ...
   Phx::Name          derivedVtableName = Phx::Name::New(lifetime,
      "$Derived$Vtable");
   ...
   derivedVtableSym->Alignment = Phx::Alignment(Phx::Alignment::Kind::AlignTo4Bytes);

   // derivedVtableSym->NeedsToBeEmitted = true;

   // Now build the vtable initializer...

   Phx::IR::DataInstruction ^ derivedVtableInstr =
      Phx::IR::DataInstruction::New(rdataSection->DataUnit,
...
{
   UInt32 length = (UInt32) value->Length + 1;
...
// Description:
//
//    Wrapper around the Hello::Run method
//
// Returns:
//
//    0 on success, 1 on failure
