...
// Remarks:
//
//    Header for the "UninitializedLocal" phase PlugIn.
//
//-----------------------------------------------------------------------------
...
public:
   static Phx::Controls::SetBooleanControl ^ WarnMayCtrl;

#if defined (PHX_DEBUG_SUPPORT)

public:
   static Phx::Controls::ComponentControl ^ UninitializedLocalCtrl;

#endif

private:

   bool hasPrintedFileName;
...
public:
   ...
   {
      virtual System::String ^ get() override { return L"Uninitialized Local"; }
   }
};
}
