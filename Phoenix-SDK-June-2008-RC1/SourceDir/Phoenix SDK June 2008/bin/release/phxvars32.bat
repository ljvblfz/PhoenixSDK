@echo off
@echo Setting paths to the Phoenix Release Environment
...
@if "%1"=="x86" set PATH=%RDKRoot%\bin\release\x86\;%PATH%
@if "%1"=="x86_amd64" set PATH=%RDKRoot%\bin\release\x86_amd64\;%RDKRoot%\bin\release\x86\;%PATH%
